...
let allQuestions = [
    ...
    {
        text: 'К методам разрушения водонефтяных эмульсий относятся (Отметьте все правильные варианты ответа):',
    ...
    {
        text: 'По содержанию парафинов выделяют такие группы нефтей, как: (Отметьте все правильные варианты ответа)',
        correctAnswer: [0,2,3],
        type: 1,    // Тип вопроса с одним верным ответом
        price: 150, // Цена вопроса
        answered: null, // Флаг, ответили ли на этот вопрос
    ...
    {
        text: 'На какие группы классифицируются НПЗ по выпускаемой продукции (Отметьте все правильные варианты ответа).',
        correctAnswer: [0,1,2,5],
        type: 1,    // Тип вопроса с одним верным ответом
        price: 150, // Цена вопроса
        answered: null, // Флаг, ответили ли на этот вопрос
        answers: ['топливно-нефтехимического профиля', 'топливного профиля', 'топливно-масляно-нефтехимического профиля', 'нефтехимического профиля', 'масляного профиля','топливно-масляного профиля'],
    },
    {
    ...
    {
        text: 'Какие процессы протекают на установках ЭЛОУ (Отметьте все правильные варианты ответа):',
        correctAnswer: [0,2],
        type: 1,    // Тип вопроса с одним верным ответом
